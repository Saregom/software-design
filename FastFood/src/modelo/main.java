...
public class main {
	...
	public static void main(String[] args) {
		Comida pizza = new Comida(1, "pizza", 9.99, "buena", new ArrayList<>(List.of("harina", "huevo")),"ni puta Idea"); 
		...
		Comida hamburguesa = new Comida(2, "hamburgesa", 9.99, "buena", new ArrayList<>(List.of("harina", "huevo")),"ni puta Idea"); 
